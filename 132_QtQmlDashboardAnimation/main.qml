...
Window {
    ...
    Image {
        ...
        Column{
            ...
            Text { text: "rpm : " + carData.engine.rpm}
            Text { text: "speed : " + carData.speed}
            Text { text: "distance : " + carData.distance}
            Text { text: "gear : " + carData.engine.gear}
        }
        CarInfo{
            id : carData
            visible: true
        ...
        Item{
            ...
            width: 400
            height: 400
            function calcuratePosition(angle,radius){
                if(radius === undefined)
                    radius = width/2 * 0.8;
            ...
            Repeater{
                model: 7
                Item {
                    property point pt: leftContainer.calcuratePosition(120 + index * 35)
                    x : pt.x
                    y : pt.y
                    Label{
                        anchors.centerIn: parent
        ...
        Item {
            ...
            Repeater{
                model: 12
                Item{
                    property point pt: middleContainer.calculatePosition(120 + index * 24)
                    x : pt.x ; y : pt.y
                    Label{
                        anchors.centerIn: parent
                        text: index * 20
            ...
            Repeater{
                ...
                Item{
                    property point pt : middleContainer.calculatePosition(
                              120 + index * 2.4, middleContainer.width * 0.35)
                    x : pt.x; y : pt.y
                    Rectangle{
                        width: 2
                        height: index % 5 ? 5 : 10
                        color: "white"
                        rotation: 90 + 120 + index * 2.4
                        anchors.centerIn: parent
                        antialiasing: true
                    }
                }
