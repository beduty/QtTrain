...
public:
    ...
    void addHighlight(ChessView::Highlight* hl);
    void removeHighlight(ChessView::Highlight* hl);
    inline ChessView::Highlight* highlight(int index) const {return m_highlights.at(index);}
