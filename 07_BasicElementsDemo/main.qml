...
Window {
    ...
    Image {
        ...
        width: 100; height: 100
         // 빌드 파일에 있는 이미지를 연다.
        source: "file:AlignR.bmp"
    }
    Image {
        x : 120; y: 30
        width: 100; height: 100
        // resource로 등록한 이미지를 넣는다.
        source: "images/111.PNG"
    }
    Image {
        x : 230; y: 30
        width: 100; height: 100
        // 지정한 Full Path로 연다.
        source: "file:///C:/Users/jungt/Desktop/AIK-SKC_TestIMG/Stack.bmp"
    }
    Image {
        x : 340; y: 30
        width: 100; height: 100
        // 웹 상의 이미지도 열 수 있다.
        source: "http://bitly.kr/SvEvufp27x"
    }
